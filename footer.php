...
<footer class="spacer">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <h4>Hotel Aston</h4>
                    <p>Aston Tanjung Pinang Hotel & Conference Center terletak hanya 7 menit dari Bandara Internasional Raja Haji Fisabilillah dan terletak di antara bandara dengan Bintan Centre Business District. Selain itu, hotel ini juga memiliki akses mudah ke kantor-kantor pemerintah, pusat kegiatan bisnis serta tempat-tempat wisata. </p>
                </div>              
...
<div class="text-center copyright">Copyright (c) reserved by <a href="index.php">Hotel Aston</a></div>
